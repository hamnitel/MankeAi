...
<!-- 截图位置：分镜编辑器 / 编剧界面 -->
![分镜编辑器](docs/screenshots/03-panel-editor.png)
...
![角色设计工坊](docs/screenshots/02-character-designer.png)
...
<!-- 截图位置：4K 画质生成效果 / 灯箱查看 -->
![4K 渲染效果](docs/screenshots/04-4k-render.png)
...
<!-- 截图位置：导出菜单 / 本地文件夹 -->
![导出与本地归档](docs/screenshots/05-export.png)
...
前往 [Releases 页面](../../releases) 下载最新版安装包：

- **Setup 安装版** — 标准 Windows 安装向导
- **便携版** — 双击即用，免安装
...
**生成的图片可以商用吗？**
你在漫刻 AI 生成的所有角色、分镜与漫画插图均享有完整使用权，支持商业出版、自媒体发布与周边衍生。

**换了电脑，我的漫画项目还在吗？**
项目数据保存在本地。如需迁移，建议绑定本地文件夹将图片与剧本导出备份。

**怎么让同一角色在不同分镜里服饰发型完全一致？**
先在角色工坊生成该角色的 5-PLATE 设定卡并存入项目，然后在分镜编辑器里把该角色关联到目标分镜即可。
